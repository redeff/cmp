...
void dfs(int node, int len, vector<double> &dist, vector<vector<Conn>> &tree) {
...
const double INF = 333333;

vector<double> calc_dist(int node, vector<vector<Conn>> &tree) {
    vector<double> dist(tree.size(), INF);
